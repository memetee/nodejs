...
![image-20221006161223082](D:\studyMaterial\node\笔记\10、Express框架\image-20221006161223082.png)
...
![image-20221006161446626](D:\studyMaterial\node\笔记\10、Express框架\image-20221006161446626.png)
...
![image-20221006161740474](D:\studyMaterial\node\笔记\10、Express框架\image-20221006161740474.png)
...
![image-20221006161920525](D:\studyMaterial\node\笔记\10、Express框架\image-20221006161920525.png)
...
- 在request对象中要获取可以通过 req.params.userId;
  ...
  ![image-20221006162515497](D:\studyMaterial\node\笔记\10、Express框架\image-20221006162515497.png)
...
- https://www.expressjs.com.cn/guide/routing.html
  ...
  ![image-20221006162848816](D:\studyMaterial\node\笔记\10、Express框架\image-20221006162848816.png)
...
![image-20220926071710746](D:\studyMaterial\node\笔记\10、Express框架\image-20220926071710746.png)
...
![image-20220926071335206](D:\studyMaterial\node\笔记\10、Express框架\image-20220926071335206.png)
...
![image-20221006164220449](D:\studyMaterial\node\笔记\10、Express框架\image-20221006164220449.png)
...
![image-20220926073521526](D:\studyMaterial\node\笔记\10、Express框架\image-20220926073521526.png)

所以一般是这样写

![image-20220926073606876](D:\studyMaterial\node\笔记\10、Express框架\image-20220926073606876.png)
...
![image-20221006203412337](D:\studyMaterial\node\笔记\10、Express框架\image-20221006203412337.png)

or

![image-20221006203516063](D:\studyMaterial\node\笔记\10、Express框架\image-20221006203516063.png)

如果是其他的请求，就不行

![image-20221006203542577](D:\studyMaterial\node\笔记\10、Express框架\image-20221006203542577.png)
...
![image-20220926205727655](D:\studyMaterial\node\笔记\10、Express框架\image-20220926205727655.png)
...
![image-20220926072218967](D:\studyMaterial\node\笔记\10、Express框架\image-20220926072218967.png)
...
![image-20221007084422938](D:\studyMaterial\node\笔记\10、Express框架\image-20221007084422938.png)
...
![image-20221007092323975](D:\studyMaterial\node\笔记\10、Express框架\image-20221007092323975.png)
...
![image-20221007094636664](D:\studyMaterial\node\笔记\10、Express框架\image-20221007094636664.png)
...
![image-20220926215347757](D:\studyMaterial\node\笔记\10、Express框架\image-20220926215347757.png)
...
![image-20221008201030018](D:\studyMaterial\node\笔记\10、Express框架\image-20221008201030018.png)
...
![image-20221008201404600](D:\studyMaterial\node\笔记\10、Express框架\image-20221008201404600.png)
...
![image-20221008201648779](D:\studyMaterial\node\笔记\10、Express框架\image-20221008201648779.png)
...
![image-20221008203833498](D:\studyMaterial\node\笔记\10、Express框架\image-20221008203833498.png)
...
![image-20221008204835233](D:\studyMaterial\node\笔记\10、Express框架\image-20221008204835233.png)
...
![image-20221008205006765](D:\studyMaterial\node\笔记\10、Express框架\image-20221008205006765.png)
...
![image-20220927071011005](D:\studyMaterial\node\笔记\10、Express框架\image-20220927071011005.png)
...
- multer配置的dest获取到的数据会有问题
  ...
  ![image-20221008213251932](D:\studyMaterial\node\笔记\10、Express框架\image-20221008213251932.png)
...
![image-20221008213457282](D:\studyMaterial\node\笔记\10、Express框架\image-20221008213457282.png)

可以看到，这样就可以拿到正确的图片了

当然，也可以获取单独的图片

![image-20221008213822664](D:\studyMaterial\node\笔记\10、Express框架\image-20221008213822664.png)
...
// 第二个参数获取上传的文件，通过file获取到上传的文件的名字
app.post('/login', upload.single('file'), (req, res, next) => {
  console.log(req.body);
  res.end('登录成功~')
})
...
- 还有另一种上传多个图片的方式
  ...
  ![image-20221008215520064](D:\studyMaterial\node\笔记\10、Express框架\image-20221008215520064.png)
  ...
  ![image-20221008215648934](D:\studyMaterial\node\笔记\10、Express框架\image-20221008215648934.png)

  可以看到，files拿到上传的文件

- 注意：multer有一个很重要的地方

  ![image-20221008215803468](D:\studyMaterial\node\笔记\10、Express框架\image-20221008215803468.png)
...
![image-20221008221435824](D:\studyMaterial\node\笔记\10、Express框架\image-20221008221435824.png)
...
![image-20221008221533111](D:\studyMaterial\node\笔记\10、Express框架\image-20221008221533111.png)
...
![image-20221008223221420](D:\studyMaterial\node\笔记\10、Express框架\image-20221008223221420.png)
...
![image-20221008223523715](D:\studyMaterial\node\笔记\10、Express框架\image-20221008223523715.png)
...
![image-20221008223838643](D:\studyMaterial\node\笔记\10、Express框架\image-20221008223838643.png)
...
![image-20221008225053304](D:\studyMaterial\node\笔记\10、Express框架\image-20221008225053304.png)
...
![image-20221008230841299](D:\studyMaterial\node\笔记\10、Express框架\image-20221008230841299.png)
...
![image-20220926225707432](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225707432.png)

![image-20220926225720737](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225720737.png)
...
![image-20220926225757584](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225757584.png)

![image-20220926225809070](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225809070.png)
...
![image-20220926225846747](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225846747.png)

![image-20220926225855965](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225855965.png)
...
![image-20220926225919463](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225919463.png)

![image-20220926225938573](D:\studyMaterial\node\笔记\10、Express框架\image-20220926225938573.png)